    ...
    <div className="manual-shell">
      <section className="hero">
        <div>
          ...
          <h1>Wallet-driven smoke test</h1>
          <p className="lede">
            This page is the direct harness for planning commitments, injecting evidence, requesting agent recommendations, and
            signing the resulting onchain actions.
          </p>
        </div>
        ...
        <article className="card">
          ...
          <label>
            ...
            <input
              type="number"
              value={chainId}
              onChange={event => setChainId(Number.parseInt(event.target.value || "8453", 10))}
            />
          </label>
          <label>
            RPC URL
